...
public interface Try<T> {
     ...
     * <em>Throwable</em> are wrapped in a unchecked exception avoiding the clients the requirement
     * to catch or rethrow the exceptions.
     *
     * <p>
     *
     * <pre>
     ...
     *
     * @return an Optional that contains the computation result if Success, <em>empty</em>
     *     otherwise.
     */
    ...
    /**
     * Return the computation result if <em>Success</em>, or the value provided by the given
     * function.
     *
     * @param supplier the function to supply a computation result for <em>Failure</em>
     * @return the computation result if <em>Supplier</em>, or a default value supplied by a
     *     function.
     */
