...
class PaginatedResultTest {
    ...
    void is_checking_whether_there_is_a_previous_page() {
        ...
        var results =
                IntStream.range(0, 10).mapToObj(Integer::toString).collect(Collectors.toList());
    ...
    void is_checking_whether_there_is_a_next_page() {
        ...
        var results =
                IntStream.range(0, 5).mapToObj(Integer::toString).collect(Collectors.toList());
    ...
    void is_expecting_a_result_with_one_element_more_to_make_the_check_for_the_next_page() {
        ...
        assertThat(pr.getResults().collect(Collectors.toList()))
